import { t as KakobuyLogo } from "./LitBuyLogo-D5ELNQH3.js";
import { t as content_png_asset_default } from "./content.png.asset-CUT0zvIv.js";
import { jsx, jsxs } from "react/jsx-runtime";
import { Download, Link, Puzzle, ShieldCheck, Zap } from "lucide-react";
var co1ntent_png_asset_default = { url: "/src/assets/co1ntent.png" };
var co2ntent_png_asset_default = { url: "/src/assets/co2ntent.png" };
//#endregion
//#region src/routes/wtyczka.tsx?tsr-split=component
		...
		children: [
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Puzzle, { className: "h-3.5 w-3.5" }), " Wtyczka do Chrome"]
					}),
					/* @__PURE__ */ jsxs("h1", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("a", {
							...
							children: [/* @__PURE__ */ jsx(Download, { className: "h-5 w-5" }), "Zainstaluj wtyczkę"]
						}), /* @__PURE__ */ jsxs("div", {
							className: "inline-flex items-center gap-2 text-sm text-muted-foreground",
							children: [/* @__PURE__ */ jsx(KakobuyLogo, { size: 18 }), " działa z KakoBuy"]
						})]
					})
				] }), /* @__PURE__ */ jsx("div", {
				...
				children: [
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(f.icon, { className: "h-5 w-5 text-litbuy" })
						}),
						/* @__PURE__ */ jsx("h3", {
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [/* @__PURE__ */ jsxs("h2", {
						...
						children: ["Konwertuj ", /* @__PURE__ */ jsx("span", {
							className: "text-litbuy",
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					/* @__PURE__ */ jsxs("h2", {
						className: "font-display text-3xl md:text-4xl font-bold leading-tight",
						children: ["Wiedz, zanim ", /* @__PURE__ */ jsx("span", {
							className: "text-litbuy",
					...
					/* @__PURE__ */ jsxs("a", {
						...
						children: [/* @__PURE__ */ jsx(Download, { className: "h-4 w-4" }), "Pobierz z Chrome Web Store"]
					})
				] }), /* @__PURE__ */ jsx("div", {
					className: "rounded-3xl overflow-hidden border bg-card/40 shadow-2xl",
					children: /* @__PURE__ */ jsx("img", {
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(KakobuyLogo, { size: 16 }), " AxelReps × KakoBuy"]
					}),
					/* @__PURE__ */ jsx("h2", {
					...
					/* @__PURE__ */ jsxs("a", {
						...
						children: [/* @__PURE__ */ jsx(Download, { className: "h-5 w-5" }), "Zainstaluj z Chrome Web Store"]
					})
				]
			})
		]

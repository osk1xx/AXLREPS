...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CNXOH4Ea.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-zHD-6txV.mjs"),
		import("./start-DO5H-XBG.mjs"),
		import("./empty-plugin-adapters-CaCSChxc.mjs")
	]);
	return {
		routerEntry,
		startEntry,
